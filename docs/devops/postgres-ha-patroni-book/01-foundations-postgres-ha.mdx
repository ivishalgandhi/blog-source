...
| **03 — Deploying a Patroni Cluster** | Step-by-step cluster deployment, etcd/Consul/K8s DCS choice, and the first "break it on purpose" lab ([LAB-03-A](https://github.com/ivishalgandhi/blog-source/tree/main/docs/devops/postgres-ha-patroni-book/_companion/docker/lab-03-a)). | You have a running Patroni cluster and just need configuration tuning guidance. |
